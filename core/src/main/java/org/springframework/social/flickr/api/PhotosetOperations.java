...
public interface PhotosetOperations {
     ...
     *
     * @param photosetId
     * @param primaryPhotoId The id of the photo to use as the 'primary' photo for the set.
     *                       This id must also be passed along in photo_ids list argument.
     * @param photoIds       A list of photo ids to include in the set. They will appear in
